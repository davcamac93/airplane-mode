...
create database if not exists dic9812;
...
INSERT INTO `Pilot` (name, DateHired) VALUES ('Jones','2015-01-25'),('Smith','2015-03-21'),('Walker','2015-07-23'),('Daniel','2015-04-29'),('Samuel','2015-07-20'),('Allan','2015-02-15'),('Madison','2015-01-14'),('Ryan','2015-05-01');
